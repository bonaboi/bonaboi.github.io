...
function renderSite() {
    ...
    // Set document title
    document.title = s.title + ' – Massage & Wellness';
        ...
        card.innerHTML = `
            ...
            <div class="escort-card-body">
                ...
                <div class="escort-card-actions">
                    <a href="booking.html" class="btn btn-gold" style="padding:0.6rem 1.2rem;font-size:0.65rem;">Book Now</a>
                    <button class="btn btn-outline" onclick="toggleChat()" style="padding:0.6rem 1.2rem;font-size:0.65rem;">Message</button>
                </div>
            </div>`;
